window.addEventListener(`DOMContentLoaded`, (e)=>{
    ...
    //     let donneesLocal=JSON.parse(localStorage.SESSION_TRANSPORT);
    //     let today=new Date();
    //     let expiredDate=new Date(donneesLocal.exprire);
    //     if(today-expiredDate>2*60*60*1000){
    //         localStorage.removeItem('SESSION_TRANSPORT');
    //         let localIntervalle=setInterval(()=>{
    //             location.href = location.href;
    //             clearInterval(localIntervalle);
    //         },500)
    //     }
    // }
